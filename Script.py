...
•─────•─────────•─────•
🏷️ <a href='https://t.me/ganeshmrxx'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @ganeshmrxx
...
💳 ᴜᴘɪ ɪᴅ - <code>Temporary not available so Contact my admin <b>@ganeshmrxx</b></code>
